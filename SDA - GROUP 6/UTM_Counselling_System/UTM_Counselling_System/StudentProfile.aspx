<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentProfile.aspx.cs" Inherits="UTM_Counselling_System.StudentProfile" %>
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" placeholder="Enter Matric Number" name="matricnumber" id="matricnumber" runat="server" required>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="number" placeholder="Enter Age" name="age" id="age" runat="server" required>
                </td>
            </tr>
             <tr>
                <td>
