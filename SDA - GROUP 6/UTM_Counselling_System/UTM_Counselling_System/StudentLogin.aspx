<%@ Page Title="Student Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentLogin.aspx.cs" Inherits="UTM_Counselling_System.StudentLogin" %>
    ...
    <div class="container">
        ...
        <div class="container" style="background-color: #f1f1f1">
          ...
          <%--   <asp:Button ID="btnCancel" runat="server" CssClass="button" Text="Cancel"/> --%>
            ...
            <span class="psw">Sign Up <a href="StudentSignup.aspx"><b>HERE</b></a></span>
        </div>
    </div>
</asp:Content>
